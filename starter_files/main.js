...
(function() {
  ...
  ***********************/
  ...
  console.assert(combos.length == 25, {
    "message": "`combos.length` does not equal 25",
    "combos.length": combos.length
  });
  console.assert(utility.areArraysEqual(combos, utility.combos), {
    "message": "`combos` does not contain all combinations of letters",
    "combos": combos
  });
})();
...
(function() {
  ...
  ***********************/
  ...
  if (timeOfDay > 600 && timeOfDay < 900 || timeOfDay > 400 && timeOfDay < 600) {
    console.log("Go around the city ")
  } else {
    console.log("Go into the city ")
  }
...
(function() {
  ...
  ***********************/
  ...
  console.assert(factorial(4) == 24, {
    "message": "factorial( 4 ) doesn't equal 4",
    "factorial( 4 )": factorial(4)
  });
  console.assert(factorial(6) == 720, {
    "message": "factorial( 6 ) doesn't equal 6",
